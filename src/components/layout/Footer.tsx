        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-16">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex gap-4 mt-4">
              <a href="https://www.linkedin.com/showcase/signbuddy/" className="text-gray-400 hover:text-white">
              ...
              <a href="https://www.instagram.com/signbuddy_syncore/" className="text-gray-400 hover:text-white">
                <div className="w-10 h-10 rounded-lg border border-white/30 flex items-center justify-center">
              ...
              <a href="https://x.com/SyncoreLabs" className="text-gray-400 hover:text-white">
                <div className="w-10 h-10 rounded-lg border border-white/30 flex items-center justify-center">
