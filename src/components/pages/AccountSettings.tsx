...
const [verifyMessage, setVerifyMessage] = useState('');
    ...
    const handleDeleteAccount = async () => {
        try {
            ...
            const response = await fetch('https://server.signbuddy.in/api/v1/me/profile-delete', {
                method: 'DELETE',
                headers: {
    ...
    const handlePasswordUpdate = async () => {
        try {
            ...
            if (isGoogleUser) {
                ...
                response = await fetch('https://server.signbuddy.in/api/v1/resetpassword', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                ...
                response = await fetch('https://server.signbuddy.in/api/v1/me/changepassword', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`
        ...
        <div className="bg-black min-h-[calc(100vh-64px)]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-sm sm:text-base text-gray-500">Manage your profile information, update your avatar, and modify your account settings</p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[200px,1fr] gap-6">
                    ...
                    <div className="flex lg:flex-col gap-2 lg:space-y-1.5 overflow-x-auto pb-2 lg:pb-0">
                        ...
                        <button
                            ...
                            className={`w-full text-center px-3 py-2 rounded-lg ${activeTab === 'password' ? 'bg-white/5 border border-white/10' : 'hover:bg-white/5 text-gray-400'
                                }`}
                        >
                            Password Settings
                        </button>
                                            ...
                                            {!isLoading && avatars
                                                ...
                                                .map((avatar) => (
                                                    <button
                                                        ...
                                                        className={`w-[50px] h-[50px] rounded-full overflow-hidden relative ${selectedAvatar === avatar.url ? 'ring-4 ring-blue-500' : ''
                                                            }`}
                                                    >
                                                        <img
                                                            src={avatar.url}
                         ...
                         activeTab === 'password' && (
                                <div className="bg-[#111] rounded-lg border border-white/10 p-4 sm:p-6">
                                    <div className="max-w-xl space-y-6">
                                        {!isGoogleUser && (
                                            <div>
                                                <label className="block text-xl mb-2 sm:mb-4">Current Password</label>
                                                <input
                                                    type="password"
                                        ...
                                        <div>
                                            <label className="block text-xl mb-4">Confirm Password</label>
                                            <input
                                                type="password"
                    ...
                    <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4">
                        <div className="bg-[#111] rounded-lg w-full max-w-[500px] p-6 sm:p-8 relative">
                            ...
                            <p className="text-gray-400 text-lg mb-8">
                                An OTP has been sent to your account to change the email, please enter it below.
                            </p>
            ...
            {showDeleteModal && (
                <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
                    <div className="bg-[#111] rounded-lg w-full max-w-[500px] p-6 sm:p-8 relative">
                        ...
                        <h2 className="text-3xl font-semibold mb-4 text-red-500">Delete Account</h2>
                        <p className="text-gray-400 text-lg mb-8">
